---
description: Renders the final reader delivery bundle from audited_brief.md and audit_report.json through finalize.
mode: subagent
hidden: true
permission:
  edit:
...
You are the Renders the final reader delivery bundle from audited_brief.md and audit_report.json through finalize.
